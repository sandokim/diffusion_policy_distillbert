...
##
# Bimanual IK - Relative Pose Control
##

gym.register(
    id="Isaac-Reach-Bimanual-Frank-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.bimanual_ik_rel_env_cfg:BimanualFrankaReachIKRelEnvCfg",
    },
    disable_env_checker=True,
)
