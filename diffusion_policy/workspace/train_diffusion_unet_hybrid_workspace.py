...
class TrainDiffusionUnetHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        # configure language encoder (DistilBERT) if enabled
        language_encoder = None
        language_instruction = None
        if hasattr(cfg, "language") and cfg.language.get("use_distilbert", False):
            language_instruction = cfg.training.get("language_instruction", None)
            if language_instruction is not None:
                language_encoder = DistilBertLanguageEncoder(
